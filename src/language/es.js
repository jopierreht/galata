export const spanish = {
    ...
    "Stay upto date with restaurants and foods around you":
        "Stay upto date with stores and foods around you",
    ...
    "Search foods in restaurant ": "Search articles in store ",
    "Filter Your Search Results": "Filter Your Search Results",
    ...
    "Open your own  virtual restaurant on":
        "Open your own  virtual store on",
    "Are you sure you want to  logout?": "Are you sure you want to  logout?",
    ...
    "Previously added restaurant foods have been removed from cart. Now, try again.":
        "Previously added store foods have been removed from cart. Now, try again.",
    ...
    "No Cuisine Restaurant Found": "No store found",
    ...
    "You can not Order more then 1000৳ on COD order":
        "You can not Order more then 10000G on COD order",
    WishList: "WishList",
    ...
    "Select location first to start exploring shops & restaurants near you":
        "Select location first to start exploring stores near you",
    Cart: "Cart",
    Store: "Store",
    We: "We",
    satisfied: "satisfied",
    "some Customer & Restaurant Owners": "some Customer & Store owners",
